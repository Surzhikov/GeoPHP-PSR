...
namespace GeoPHP\GeoPHP;

use GeoPHP\GeoPHP\Adapters\GeoAdapter;
use GeoPHP\GeoPHP\Adapters\WKT;
use GeoPHP\GeoPHP\Adapters\GeoJSON;
use GeoPHP\GeoPHP\Geometry\Geometry;
use GeoPHP\GeoPHP\Geometry\GeometryCollection;
use GeoPHP\GeoPHP\Geometry\Point;
use GeoPHP\GeoPHP\Geometry\Polygon;
use GeoPHP\GeoPHP\Geometry\LineString;
use GeoPHP\GeoPHP\Geometry\MultiPoint;
use GeoPHP\GeoPHP\Geometry\MultiPolygon;
use GeoPHP\GeoPHP\Geometry\MultiLineString;
...
class GeoPHP
{
  ...
  public static function load()
  {
    ...
    $processor_type = "GeoPHP\\GeoPHP\\Adapters\\".$type_map[$type];
